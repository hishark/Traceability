...
public class BasePop extends BasePopupView {
    PartShadowContainer attachPopupContainer;

    public BasePop(@NonNull Context context) {
        super(context);
        attachPopupContainer = findViewById(com.lxj.xpopup.R.id.attachPopupContainer);
    ...
    protected int getPopupLayoutId() {
        return com.lxj.xpopup.R.layout._xpopup_attach_popup_view;
    }
